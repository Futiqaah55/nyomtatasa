function kalkulal() {
    ...
    document.getElementById('terulet').textContent = area.toFixed(2); 
    document.getElementById('papir').textContent = paperCost; 
    document.getElementById('koltseg').textContent = totalCost.toFixed(2); 
